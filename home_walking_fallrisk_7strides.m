...
load('seven_strides_ABC_all.mat')
...
save('April_26_21_home_raw_walking_7str_all_bouts_abc','test_total_labels','test_scores','test_pred','training_accuracy','threshold','net');
