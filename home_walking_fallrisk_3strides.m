...
save('April_08_21_home_walking3str1','validation_total_labels','validation_scores','validation_pred','training_accuracy','threshold','net','sub_ind','sub_name','options');
